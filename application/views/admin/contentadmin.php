	...
	<?php foreach ($unique as $row): ?>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      ...
			      <input type="text" name="car_number" class="form-control" required="true" id="car_number" placeholder="Input Car Number"
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="nama_driver" class="form-control" required="true" id="nama_driver" placeholder="Input Nama Driver Here" value="<?php echo $row['nama_driver'];?>">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="tempat_service" class="form-control" required="true" id="tempat_service" placeholder="Input TEMPAT SERVICE Here"  value="<?php echo $row['tempat_service'];?>">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="stnk_date" class="form-control date" required="true" id="stnk" placeholder="Input STNK Date Here" value="<?php echo $row['stnk_date'];?>" >
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="pkb_date" class="form-control date" required="true" id="pkb" placeholder="Input PKB Date Here" value="<?php echo $row['pkb_date'];?>" >
			    </div>
			  </div>
