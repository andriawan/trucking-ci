<div class="col-md-9 main-content">
	...
	<div class="col-md-12 main-content list">
		...
		<?php echo form_open('dashboard/submitEditUser','class="form-horizontal"'); ?>

				<!-- HIDDEN VALUE -->
				<input type="hidden" class="id" name="id" 
					value="<?php echo isset($data['0']['id']) ? $data['0']['id'] : (isset($data['id']['value']) ? $data['id']['value'] : '')  ?>" />
			    ...
			    <div class="col-sm-10">
			      ...
			      value="<?php echo isset($data['0']['email']) ? $data['0']['email'] : (isset($data['email']['value']) ? $data['email']['value'] : '') ?>" 
			      >
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      ...
			      value="<?php echo isset($data['0']['username']) ? $data['0']['username'] : (isset($data['username']['value']) ? $data['username']['value'] : '') ?>" 
			      >
			    </div>
			  </div>
